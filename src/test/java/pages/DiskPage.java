...
public class DiskPage {
    ...
    public DiskPage confirmFolderCreation() {
        Waiters.waitForVisibility(5, driver, confirmNameButton);
    ...
    public DiskPage uploadFile() {
        uploadButton.sendKeys(new File("src/test/resources/FileToUpload.txt").getAbsolutePath());
        return this;
    }
